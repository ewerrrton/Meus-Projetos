...
public class ValorMaisProximo {
    ...
    private ArrayList<Integer> preOrder(Node node, ArrayList<Integer> order) {
        if(node == null) {
            return order;
        }
    ...
    public String saida() {
        ...
        StringBuilder sb = new StringBuilder();
            while(i < array.size()) {
            sb.append(array.get(i)).append(",").append(balance.get(i)).append(" ");
            i++;
        }
        return sb.toString();
    }
